...
// Or better, just insert one directly via DB connection since this is a test script running on server
...
if ($resMac->num_rows > 0) {
    ...
    $conn->query("INSERT INTO machines (name, category_id, operator_id) VALUES ('Test Machine', 1, $operatorId)");
